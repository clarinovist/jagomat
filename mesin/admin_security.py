...
def buat_tinjauan(akun, token_sesi, aksi, payload=None, *, sekarang=None,
    ...
    isi = dict(payload or {})
    if set(isi) - {'target_id', 'target_revisi', 'target_peran', 'siswa_id', 'tingkat', 'revisi', 'batch_id', 'section', 'pilihan', 'halaman', 'item_ids', 'login_id', 'login_revisi', 'revisi_profil', 'bulan', 'akun', 'invoice', 'tahap'}:
